...
# Base script to fine-tunine a wav2vec 2.0 large-960h-lv60-self model with UWB-ATCC database
...
echo "Done training facebook/wav2vec2-large-960h-lv60-self model for UWB-ATCC in: $exp"
exit 1
