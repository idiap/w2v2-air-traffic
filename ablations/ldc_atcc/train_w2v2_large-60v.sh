...
# Base script to fine-tunine a wav2vec 2.0 large-960h-lv60-self model with LDC-ATCC database
...
echo "Done training facebook/wav2vec2-large-960h-lv60-self model for LDC-ATCC in: $exp"
exit 1
