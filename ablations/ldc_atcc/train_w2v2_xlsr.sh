...
# Base script to fine-tunine a wav2vec 2.0 wav2vec2-xls-r-300m model with LDC-ATCC database
...
echo "Done training facebook/wav2vec2-xls-r-300m model for LDC-ATCC in: $exp"
exit 1
