...
# Base script to fine-tunine a wav2vec 2.0 model with MINERVA database
...
dataset_name="experiments/data/minerva/train"
eval_dataset_name="experiments/data/minerva/test"
...
echo "Done training of baseline model for MINERVA database"
exit 0
